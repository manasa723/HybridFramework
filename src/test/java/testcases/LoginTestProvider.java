...
public class LoginTestProvider extends Page {
	...
	public void test(String id,String pwd) throws Exception
	{
		...
		if(actmsg != null)
		{
			Connection con=POIConfig.makeConnection("D:\\corejava\\Book3.xls"); // have to make connection as before data is added to array from getData() yaha connection open nahi hai
